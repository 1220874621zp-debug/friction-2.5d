...
QString translatePropertyName(const QString& name) {
    static const QHash<QString, QString> map = {
        ...
        { QStringLiteral("CC Smear"),
          BoxSingleWidget::tr("CC Smear") },
        { QStringLiteral("from X"),
          BoxSingleWidget::tr("from X") },
        { QStringLiteral("from Y"),
          BoxSingleWidget::tr("from Y") },
        { QStringLiteral("to X"),
          BoxSingleWidget::tr("to X") },
        { QStringLiteral("to Y"),
          BoxSingleWidget::tr("to Y") },
        { QStringLiteral("elasticity"),
          BoxSingleWidget::tr("elasticity") },
        { QStringLiteral("Shatter"),
          BoxSingleWidget::tr("Shatter") },
        { QStringLiteral("progress"),
          BoxSingleWidget::tr("progress") },
        { QStringLiteral("pieces"),
          BoxSingleWidget::tr("pieces") },
        { QStringLiteral("dispersion"),
          BoxSingleWidget::tr("dispersion") },
        { QStringLiteral("gravity"),
          BoxSingleWidget::tr("gravity") },
        { QStringLiteral("Roughen Edges"),
          BoxSingleWidget::tr("Roughen Edges") },
        { QStringLiteral("border"),
          BoxSingleWidget::tr("border") },
        { QStringLiteral("edge sharpness"),
          BoxSingleWidget::tr("edge sharpness") },
        { QStringLiteral("complexity"),
          BoxSingleWidget::tr("complexity") },
        { QStringLiteral("evolution"),
          BoxSingleWidget::tr("evolution") },
    };
...
void BoxSingleWidget::mousePressEvent(QMouseEvent *event) {
    ...
    if(event->button() == Qt::RightButton) {
        ...
        // AE-style "select same label color" for box/sound rows; the
        // layer-marker ops live on the track right-click (KeysView)
