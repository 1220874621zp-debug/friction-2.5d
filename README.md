...
31. **ai深度分析** -图像深度通道分析，适合ai参考视频使用，后期方面也有很大价值
32.  **自动匹配画布按钮** -等比例匹配画布
33.   **位图转矢量** -菜单栏独立菜单
34.    **文字预设面板** -支持文字，图像快捷动画应用，类似ae码头人插件，未来可扩展更多内容
35. **切换面板** -复刻moho切换器面板，适合口型动画，动作切换，原生面板，性能更好
36.  **项目面板** -新增项目面板，合并场景和素材管理，和ae一样
